...
public class Baseline {
  ...
  public boolean equals(Object o) {
    ...
    if (baselineId != baseline.baselineId) {
      return false;
    }
    if (userId != baseline.userId) {
      return false;
    }
    if (tenantId != null ? !tenantId.equals(baseline.tenantId) : baseline.tenantId != null) {
      return false;
    }
    if (vertical != null ? !vertical.equals(baseline.vertical) : baseline.vertical != null) {
      return false;
    }
